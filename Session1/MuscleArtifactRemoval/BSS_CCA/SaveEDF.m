...
% filename - File name
% data - Contains a signals matrix (mn n - quantity of channels, m -
...
for n=1:header.channels
    ...
    if isempty(header.prefilt{n}), header.prefilt{n}=' '; elseif length(header.prefilt{n})>80,header.prefilt{n}=header.prefilt{n}(1:80);end
